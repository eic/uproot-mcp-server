...
1. **GitHub Private Vulnerability Reporting** – Use the [Report a vulnerability](https://github.com/eic/uproot-mcp-server/security/advisories/new) button on the Security tab of this repository. This is the preferred method.
...
This policy applies to the `uproot-mcp-server` source code. Vulnerabilities in upstream dependencies (e.g., `uproot`, `awkward`, `numpy`, `mcp`) should be reported to their respective maintainers.
